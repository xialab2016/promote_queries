...
pbmc2$subject_group <- factor(pbmc2$subject_group, levels = c(1,2,3,99), labels = c("MS", "Other NID", "Controls", "Unknown"))
pbmc2$subtype_blood <- factor(pbmc2$subtype_blood, levels = c(1,2,3,4,5,6,99), labels = c("CIS", "RIS", "RRMS", "SPMS", "PPMS", "NMO", "Does not have MS"))
...
pbmc2 <- pbmc2[,c("id_participant", "dob", "age_collection", "subject_sex", "race", "ethnicity", "subject_group", "blood1_date", "subtype_blood", "disease_duration", "blood1_dmt_detail")]
