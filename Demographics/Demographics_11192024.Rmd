...
demographics_final$dx_group_main <- factor(demographics_final$dx_group_main, levels = c(1:6), labels = c("Healthy Control", "MS", "NID+OND", "NID+OND","NID+OND","NID+OND")) 
...
d$dx_group_main <- factor(d$dx_group_main, levels = c("MS", "NID+OND", "Healthy Control"), labels = c("MS", "NID+OND", "Healthy Control"))
...
ggsave("/Users/Desktop/MS Clinic/sex_age_density.png", plot = last_plot(), width = 6.67, height = 7.2, units = "in")
dev.off()
...
ggsave("/Users/Desktop/MS Clinic/sex_onset_density.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
ggsave("/Users/Desktop/MS Clinic/sex_bar.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(sex_grouped)
 ...
 ggsave("/Users/Desktop/MS Clinic/sex_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(duration_type_density)
 ...
 ggsave("/Users/Desktop/MS Clinic/duration_type_density.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
# DMT Plots ==========
# In this section, we have two versions of the bar charts: stacked and grouped!
#MP: For DMTs,  we've changed the diagnosis label from NID+OND to just "NID". This adjustment is for the stacked chart only, if the same change is needed for the grouped chart, you  can make the same adjustment below.
...
dmt_stacked<- d %>%
  ...
  axis.title.x = element_blank(), 
  axis.text.x = element_blank()) +
  scale_y_discrete(labels = c("Healthy Control" = "Healthy Control", 
                              "NID+OND" = "NID", 
                              "MS" = "MS"))
print(dmt_stacked)

ggsave("/Users//Desktop/MS Clinic/dmt_stacked.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(dmt_grouped)
 ...
 ggsave("/Users/Desktop/MS Clinic/dmt_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
dev.off()
...
ggsave("/Users/Desktop/MS Clinic/duration_binned_onset.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(onset_stacked)
 ...
 ggsave("/Users/Desktop/MS Clinic/onset_stacked.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(onset_grouped)
 ...
 ggsave("/Users/Desktop/MS Clinic/onset_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(race_stacked)
 ...
 ggsave("/Users/Desktop/MS Clinic/race_stacked.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(race_grouped)
 ...
 ggsave("/Users/Desktop/MS Clinic/race_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
#ggsave("/Users/Desktop/MS Clinic/cci_plot.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
