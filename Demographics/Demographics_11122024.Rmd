...
#Import files
```{r}
setwd("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/XIA LAB/PROMOTE Materials/Data Description Paper/Source Files/2024-11-4/")
...
legacySNQ <- read.csv("Legacy_SNQ.csv") #Export of the whole PNQ Legacy project
...
d$dx_group_main <- factor(d$dx_group_main, levels = rev(levels(d$dx_group_main)))
d <- d[order(d$dx_group_main), ]
...
sex_age_density2 <- ggplot(d, aes(y = dx_group_main, x = age_enroll, fill=subject_sex, order = subject_sex, group=NA)) +
  ...
  theme(axis.title.y = element_blank(),
    axis.title.x = element_blank(), 
    axis.text.x = element_blank(),
    axis.text.y = element_text(margin = margin(t = 30, b = 30)),
    axis.ticks.lengths.y = unit(1, "cm")
 ) 

print(sex_age_density2)

ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/sex_age_density.png", plot = last_plot(), width = 6.67, height = 7.2, units = "in")
dev.off()
...
print(sex_onset_density)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/sex_onset_density.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(sex_bar)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/sex_bar.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
dev.off()
...
print(sex_grouped)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/sex_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(duration_type_density)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/duration_type_density.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(dmt_stacked)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/dmt_stacked.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/dmt_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
dev.off()
...
print(duration_binned_onset)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/duration_binned_onset.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(onset_stacked)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/onset_stacked.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(onset_grouped)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/onset_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(race_stacked)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/race_stacked.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
...
print(race_grouped)
 ...
 ggsave("/Users/shruthivenkatesh/Library/CloudStorage/OneDrive-UniversityofPittsburgh/SHARED PRT Data Description/2024-11-14 Figures/Figure 2/race_grouped.png", plot = last_plot(), width = 6.67, height = 4.5, units = "in")
 dev.off()
